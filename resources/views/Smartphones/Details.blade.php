    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                    <div class="card-body">
                    <h1 class="card-title">{{ $smartphone->name }}</h1>
                    <h3 class="card-subtitle mb-2 text-muted">${{ $smartphone->price }}</h3>
            ...
            <div class="col-md-12">
                ...
                <form action="/smartphones/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($smartphone->Comments) == 0 || $smartphone->Comments == null || empty($smartphone->Comments))
                    <h5 class="text-muted">No comments yet.</h5>
                @else
                    @foreach ($smartphone->Comments as $comment)
                    <div class="card col-md-12">
                        <div class="card-body">
            ...
            <a href="/smartphones/" class="card-link"> <br>&nbsp&nbsp&nbsp&nbsp&nbspGo back </br> </a>
