    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                    <div class="card-body">
                    <h1 class="card-title">{{ $camera->Model }}</h1>
                    <h3 class="card-subtitle mb-2 text-muted">${{ $camera->Price }}</h3>
            ...
            <div class="col-md-12">
                ...
                <form action="/cameras/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($camera->Comments) == 0 || $camera->Comments == null || empty($camera->Comments))
            ...
            <a href="/cameras/" class="card-link"> <br>&nbsp&nbsp&nbsp&nbsp&nbspGo back </br> </a>
