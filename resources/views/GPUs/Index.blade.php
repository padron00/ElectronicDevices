            ...
            <div class="col-md-12">
                ...
                <div class="row">
                        ...
                        <div class="card col-md-3">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">{{ $gpu->Architecture }}</h5>
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="btn-group mx-auto" role="group" aria-label="First group">
                                    ...
                                    @for ($i = 1; $i <= ceil($gpuCount/12); $i++)
                                    <a href="/gpus?pg={{$i}}" class="btn btn-secondary {{ $cpage == $i ? 'disabled' : ''}}">{{$i}}</a>
                                    @endfor
                                    <a href="/gpus?pg={{ $cpage + 1}}" class="btn btn-secondary {{$cpage == ceil($gpuCount/12) ? 'disabled' : '' }}">&gt</a>
                                </div>
                          </div>
                     </div>
                 </div>
