    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                    <div class="card-body">
                    <h1 class="card-title">{{ $laptop->laptop_name }}</h1>
                    <h3 class="card-subtitle mb-2 text-muted">${{ $laptop->price }}</h3>
            ...
            <div class="col-md-12">
                ...
                <form action="/laptops/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($laptop->Comments) == 0 || $laptop->Comments == null || empty($laptop->Comments))
